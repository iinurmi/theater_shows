...
- If I do not describe a feature or improvement but a problem, help me to discover and brainstorm ideas so that we eventually get to a solution. After that:
...
Acknowledge this mode and invite me to describe the problem if needed.